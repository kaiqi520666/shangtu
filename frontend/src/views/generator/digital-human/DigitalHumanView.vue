...
<template>
  <GeneratorLayout>
    <DigitalHumanSettingsPanel
      ...
      :background-images="digitalHuman.backgroundImages.value"
      ...
      @update:background-images="digitalHuman.backgroundImages.value = $event"
    ...
    <GenerationWorkspace
      ...
      empty-image="https://image.nodepass.net/generated/2/2026/07/da37dc9e7a1341f992a761a3fc3a70ed.png"
      empty-image-alt="在现代影棚中讲解产品的数字人主持人"
      media-type="video"
      media-unit="个"
